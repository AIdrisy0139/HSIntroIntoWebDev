...
<html>
	<head>
		...
		<script>
			...
			function changeImage()
			{
				...
				if(picCounter==1)
				{
					botImgBox.src="Pics/build/voyB1.jpeg";
				}
				if(picCounter==2)
				{
					botImgBox.src="Pics/build/voyB2.jpg";
				}	
				if(picCounter==3)
				{
					botImgBox.src="Pics/build/voyB3.jpg";
				}
				if(picCounter==4)
				{
					botImgBox.src="Pics/build/voyB5.jpg";
				}
				if(picCounter==5)
				{
					picCounter=0;
	...
	<body>
		...
		<div class="img">
			<img src="Pics/build/voyB.jpg" id="sealimage"/>
		</div>
