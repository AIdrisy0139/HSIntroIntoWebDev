...
<html>
	<head>
		<title>
			Project Olympus: Constitution Build
		</title>
		...
		<script>
			...
			function changeImage()
			{
				...
				if(picCounter==1)
				{
					botImgBox.src="Pics/build/entB.jpg";
				}
				if(picCounter==2)
				{
					botImgBox.src="Pics/build/entB1.jpg";
				}	
				if(picCounter==3)
				{
					botImgBox.src="Pics/build/entB2.png";
				}
				if(picCounter==4)
				{
					botImgBox.src="Pics/build/entB4.jpg";
				}
				if(picCounter==5)
				{
					picCounter=0;
	...
	<body>
		...
		<div class="img">
			<img src="Pics/build/entB5.jpg" id="sealimage"/>
		</div>
