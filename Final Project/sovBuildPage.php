...
<html>
	<head>
		<title>
			Project Olympus: Constituion Build
		</title>
		...
		<script>
			...
			function changeImage()
			{
				...
				if(picCounter==1)
				{
					botImgBox.src="Pics/build/sovB1.jpg";
				}
				if(picCounter==2)
				{
					botImgBox.src="Pics/build/sovB2.jpg";
				}	
				if(picCounter==3)
				{
					botImgBox.src="Pics/build/sovB3.jpg";
				}
				if(picCounter==4)
				{
					botImgBox.src="Pics/build/sovB4.jpg";
				}
				if(picCounter==5)
				{
					picCounter=0;
	...
	<body>
		...
		<div class="img">
			<img src="Pics/build/sovB.jpg" id="sealimage"/>
		</div>
